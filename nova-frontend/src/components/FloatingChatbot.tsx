...
export default function FloatingChatbot() {
    ...
    return (
        <>
            ...
            {/* Chat Window */}
            {isOpen && (
                <div className="fixed bottom-36 md:bottom-24 right-4 md:right-6 z-[200] w-[calc(100vw-2rem)] max-w-[420px] max-h-[80vh] flex flex-col glass-premium rounded-[32px] overflow-hidden animate-scale-in shadow-2xl shadow-violet-500/10 border border-white/10 origin-bottom-right transition-all duration-300">
