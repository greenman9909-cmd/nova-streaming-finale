...
export default function Navbar() {
    ...
    // Scroll logic removed - Navbar stays fixed always
    useEffect(() => {
        // Optional: Add background change logic here later if needed
    }, []);
    ...
    return (
        <>
            {/* Main Navbar - Absolute (Scrolls away) */}
            <header className="absolute top-0 left-0 w-full z-[100] pt-4">
                <div className="mx-auto max-w-7xl px-4 md:px-6">
                    <div className="h-16 md:h-20 rounded-2xl bg-black/30 backdrop-blur-xl border border-white/10 flex items-center justify-between px-4 md:px-6 shadow-2xl shadow-black/50">
