...
var __quasar_inject_dirname__ = "C:\\Users\\Owais\\Downloads\\nova main\\nova-frontend\\vendor\\anime-vsub";
config();
var quasar_config_default = configure(function({ modeName }) {
  const conf = {
    ["eslint"]: {
      // fix: true,
      // include = [],
    ...
    devServer: {
      ["https"]: !(modeName === "spa" || modeName === "pwa"),
      open: false
