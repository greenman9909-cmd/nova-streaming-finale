            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <Link to="/" className="relative flex items-center justify-center gap-3 mb-10 group">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[0.6rem] font-bold tracking-[0.2em] text-violet-300/80 uppercase">Join Us</span>
                    </div>
                </Link>
                ...
                <div className="glass-dark rounded-3xl p-8 md:p-10">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-nova-muted">Start your boundless anime journey today</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 my-6">
                        ...
                        <span className="text-nova-dim text-sm">or</span>
                        <div className="flex-1 h-px bg-white/10"></div>
                    </div>

                    {/* Checkbox Terms */}
                    <p className="text-xs text-center text-nova-dim px-4">
                        By continuing, you agree to Nova's <a href="#" className="text-white hover:underline">Terms of Service</a> and <a href="#" className="text-white hover:underline">Privacy Policy</a>.
                    </p>
